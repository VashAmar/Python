...
for i in range(0, len(storeList)):
    ...
    url = 'http://api.shoplocal.com/walgreens/2012.2/xml/getretailertaglistings.aspx?campaignid=3c090349704a5c35&citystatezip='+storeList[i][4]+'&resultset=full&listingimagewidth=300&retailertagid=2808&sortby=6&pd=46B6BF4E3C10E9ABD7A68B3F4ACDEB34B2D5D393886015B49E685759418E61C45155806E9BF419E853D2FCD810781C'
    ...
    fineprint = tree.xpath('//collection[1]/data[1]/@fineprint')
